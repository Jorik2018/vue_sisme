  ...
  ui({
    ...
    created() {
      ...
      _.initDB(12,[
            ...
            ["town", { keyPath: "id" },"/admin/directory/api/town/0/0","district"],
            ["sample", { keyPath: "id" }],
            ["pool", { keyPath: "tmpId" }],
            ...
            ["red", { keyPath: "code" },"/admin/desarrollo-social/api/red/0/0"],
            ["microred", { keyPath: "ID" },"/admin/desarrollo-social/api/microred/0/0"],
            ["establishment", { keyPath: "code" },"/admin/desarrollo-social/api/establishment/0/0"],
            ["setting", { keyPath: "code" }],
            ["cie", { keyPath: "code" },"/admin/desarrollo-social/api/cie/0/0"],
            ["emed", { keyPath: "tmpId" }],
